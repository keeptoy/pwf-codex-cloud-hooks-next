...
rollback/recovered evidence均已通过并停止在 F3C4 前。如果
...
`A_ROLLBACK` 与 `A_RECOVER`，autonomous rollback + exact-current recovery因此 PASS；F3C4 closure与 ref mutation仍未授权。
