...
|---|---|---|---|---|
| `v0.4.0` | [Pre-release](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/releases/tag/v0.4.0)；[source `fe8cd7f284ea2849f634aa68813dbb0f2cca83f9`](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/commit/fe8cd7f284ea2849f634aa68813dbb0f2cca83f9)；[version acceptance](docs/v0.4.0-cloud-hard-acceptance.md#v0-4-0-p9-c-immutable-publication-evidence) | [`pwf-codex-cloud-hooks-v0.4.0.zip`](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/releases/download/v0.4.0/pwf-codex-cloud-hooks-v0.4.0.zip)；22 entries；85,519 bytes；SHA-256 `24a412c19e220a60134547a18797fbd382a48fd5319a1f30a6d5c9b47bd53bb3` | [`init-cloud-sandbox-v0.4.0.bash`](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/releases/download/v0.4.0/init-cloud-sandbox-v0.4.0.bash)；21,565 bytes；SHA-256 `4ae21c1fc99f52b1382543fac437096d4db1d3415cb40df578f29ed82cc4c64f` | Phase 4功能、sealed-source Cloud、immutable Pre-release与公开双资产重建审计已闭合；Published Release Cloud与Latest晋级仍由后继gate证明 |
