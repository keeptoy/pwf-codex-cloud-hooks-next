...
Fresh/real Resume、legacy profile、doctor、backup、零 residue 与两份 evidence 均已闭合，F3C2 因此 PASS并停止在 F3C3 前。如果
...
已完成 `S_ROLLBACK` 与独立 `S_RECOVER`，smart rollback + exact-current recovery 因此 PASS；F3C3 live、F3C4 closure 与
ref mutation仍未授权。
