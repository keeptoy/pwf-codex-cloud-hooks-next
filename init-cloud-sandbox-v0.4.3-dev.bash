...
readonly HOOKS_VERSION="${HOOKS_VERSION:-v0.4.3-dev}"
...
è¿æ¯ä¸æ¬¡ planning-with-files lifecycle Hook é»çéªè¯ã

ä¸¥æ ¼éå¶ï¼
1. ä¸è¦è°ç¨ä»»ä½å·¥å·ï¼
2. ä¸è¦è¿è¡ shell å½ä»¤ï¼
3. ä¸è¦è¯»åä»»ä½æä»¶ï¼
4. ä¸è¦æ ¹æ® AGENTS.mdãå¯¹è¯åå®¹æå·²ç¥å­ç¬¦ä¸²æ¨æµç»æï¼
5. ä¸è¦èªè¡æé æè¡¥å¨ canaryï¼
6. åªæ¥åå¨çææ¬æ¬¡åå¤ä¹åï¼runtime å·²ç»æ³¨å¥å°ä½ ä¸ä¸æä¸­çåå®¹ã

è¯·éå­ååºä½ å®éçå°çææä»¥
PWF_GLOBAL_HOOK_CANARY
å¼å¤´çå®æ´è¡ã

ç¶åä¸¥æ ¼æä»¥ä¸æ ¼å¼åç­ï¼

SessionStart: OBSERVED æ NOT_OBSERVED
SessionStart source: å®éå¼ï¼æªè§å¯å°åå NONE
UserPromptSubmit: OBSERVED æ NOT_OBSERVED
Planning context: OBSERVED æ NOT_OBSERVED

å¦ææ²¡æå®éçå°æä¸é¡¹ï¼å¿é¡»å NOT_OBSERVEDã
ä¸è¦ä¸ºäºéªè¯èä½¿ç¨ä»»ä½å·¥å·æè¯»åä»åºæä»¶ã
