...
|---|---|---|---|---|
| `v0.3.4` | [Release](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/releases/tag/v0.3.4)；[source `59a999f705701ec67463649e9424f3d059863c81`](https://github.com/keeptoy/pwf-codex-cloud-hooks-next/commit/59a999f705701ec67463649e9424f3d059863c81)；[版本 acceptance](docs/v0.3.4-cloud-hard-acceptance.md) | `pwf-codex-cloud-hooks-v0.3.4.zip`；21 entries；77,777 bytes；SHA-256 `497e92a861bd7882129f05b28df1e23a55330db98bebe76891db5b9761bdec3b` | `init-cloud-sandbox-v0.3.4.bash`；21,565 bytes；SHA-256 `9a3df089720f4d2a3aefe5b6d12a567a23177fca7c5cab186aa9a8d52695cd40` | 完成 Phase 3.7/3.8 contract 与 inventory 瘦身；immutable tag、双资产发布和公开下载字节复核已闭合，独立 Cloud 验收另行闭合 |
